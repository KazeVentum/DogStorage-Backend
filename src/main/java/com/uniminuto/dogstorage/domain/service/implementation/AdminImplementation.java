...
import com.uniminuto.dogstorage.domain.service.interfaces.AdminInterface;
import com.uniminuto.dogstorage.persistence.entity.Admin;

@Service
public class AdminImplementation implements AdminInterface<Admin> {
    ...
    public ResponseEntity<Admin> getById(Object id) {
        try{
            ...
            throw new RuntimeException("Haz ingresado una letra u/o otro caracter diferente a un Número de tipo Long");
        }
    }
    ...
    public ResponseEntity<Admin> update(Object id, Admin adminUpdate) {
        try{
            ...
            if(optionalAdmin.isPresent()){
                ...
                throw new RuntimeException("Admin no encontrado por dicho ID para actualizar");
            }
        }catch (NumberFormatException e){
            throw new RuntimeException("Haz ingresado una letra u/o otro caracter diferente a un Número de tipo Long");
        }
